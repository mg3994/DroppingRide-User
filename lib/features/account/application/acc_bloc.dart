...
class AccBloc extends Bloc<AccEvent, AccState> {
  ...
  List<DropdownMenuItem<String>> get dropdownItems {
    List<DropdownMenuItem<String>> menuItems =  [
      DropdownMenuItem(value: "user", child: MyText(text : AppLocalizations.of(navigatorKey.currentContext!)!.user)),
      DropdownMenuItem(value: "driver", child: MyText(text : AppLocalizations.of(navigatorKey.currentContext!)!.driver)),
    ];
    return menuItems;
  }
